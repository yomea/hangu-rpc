...
import com.hangu.rpc.common.entity.ServerMethodInfo;
...
import com.hangu.rpc.common.util.HttpGenericInvokeUtils;
...
public class HttpGenericProxyFactory {
    ...
    private static RequestHandlerInfo buildRequestHandlerInfo(ServerMethodInfo serverMethodInfo) {
        ...
        parameterInfo.setType(com.hangu.rpc.common.entity.HttpServletRequest.class);
    ...
    public static com.hangu.rpc.common.entity.HttpServletRequest buildRequest(HttpServletRequest request)
        throws Exception {
        com.hangu.rpc.common.entity.HttpServletRequest apiReqest = new com.hangu.rpc.common.entity.HttpServletRequest();
    ...
    public static com.hangu.rpc.common.entity.HttpServletRequest buildRequest(FullHttpRequest request)
        throws Exception {
        com.hangu.rpc.common.entity.HttpServletRequest apiReqest = new com.hangu.rpc.common.entity.HttpServletRequest();
